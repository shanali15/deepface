...
def analysis(db_path="data/", model_name='ArcFace', distance_metric= 'cosine', enable_face_analysis = False
				, source = 'rtsp://admin:Epagingadmin@10.194.2.51/cam/realmonitor?channel=1&subtype=1', time_threshold = 1, frame_threshold = 1):
